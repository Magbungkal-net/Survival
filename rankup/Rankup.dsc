rankup_command:
    ...
    - foreach <[requirements]> as:req:
        ...
        - if <[completion]>:
            - define req_details "<[req_details]><&nl><gray>    - <green>✓ "
        - else:
    ...
    - if !<[ready_for_rankup]>:
        - narrate "<[req_details]><&8><&l>[<&gradient[from=#7C4751;to=#7C4751]><bold>Magbungkal<reset><&8><&l>] <&f>You do not meet the requirements to rankup!"
        - stop

    # commence rankup
    - if <player.has_flag[rankup.confirm]>:
        - narrate "<&8><&l>[<&gradient[from=#7C4751;to=#7C4751]><bold>Magbungkal<reset><&8><&l>] <&f>Rankup confirmed!"
    ...
    - narrate "<&8><&l>[<&gradient[from=#7C4751;to=#7C4751]><bold>Magbungkal<reset><&8><&l>] <&f>You meet the requirements to rankup to <bold><[next_rank]>!"
    - narrate "<&8><&l>[<&gradient[from=#7C4751;to=#7C4751]><bold>Magbungkal<reset><&8><&l>] <&f>Use /rankup again to confirm"
