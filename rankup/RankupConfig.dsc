rankup_config:
    ...
    global-commands:
    - ex discordmessage id:magbungkal channel:1182512909654438068 embed:<discord_embed[title=<player.name> has rankup!;thumbnail=<player.name.avatar_url>]>
    ...
    ranks:
        ...
        amethysti:
            ...
            - Who's the Pillager Now?: <player.has_advancement[adventure/kill_a_pillager_captain].if_null[false]>
            commands:
