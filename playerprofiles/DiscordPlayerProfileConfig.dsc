discord_player_profile_config:
    ...
    messages:
        player-not-online:
            ...
            color: gray
        player-unknown:
            title: Not found any player with this username.
            color: maroon
    ...
    sets:
        ...
        set_1:
            ...
            message_format:
                ...
                description: **🌟 mcMMO Level**: `<placeholder[mcmmo_power_level]>`<n>**✨ Level**: `<player.xp_level>`<n>**😴 Afk**: `<placeholder[essentials_afk]>`<n>**💰 Balance**: `₱<placeholder[vault_eco_balance_commas]>`<n>**🕒 Playtime**: `<placeholder[statistic_time_played]>`<n>**📥 Votes**: `<placeholder[superbvote_votes]>`<n>**🪙 Coins**: `<placeholder[coinsengine_balance_raw_MagbungkalCoins]>`
