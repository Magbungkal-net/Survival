frostbloom_battleaxe:
    type: item
    material: netherite_axe
    display name: <&gradient[from=#93B1FF;to=#ADF3FD]>»-Frostbloom Battleaxe-«
    enchantments:
    - looting:4
    mechanisms:
        unbreakable: true
        ...
        attribute_modifiers:
            generic_attack_damage:
                1:
                    ...
                    amount: 9.5
                    slot: hand
                    id: 9a08415d-78ed-4ae3-bfa2-82dff8397cb6
            generic_attack_speed:
                1:
                    operation: add_scalar
                    amount: 0.65
                    slot: hand
                    id: 63f99e1d-2fa5-45b8-8ceb-2542183fec8e
    lore:
    - <empty>
    -   <&b>This battleaxe blooms with frost, its cold edge capable of
    -   <&b>freezing anything it touches. Born from the heart of winter,
    -   <&b>it strikes with the unforgiving bite of a frozen landscape.
    - <empty>
    ...
    - <&8><&l>【<&b>Unbreakable<&8><&l>】
    - <empty>
    - <&8><&m><&l>==============================
    - <&8><&l>▶ <&r><&gradient[from=#D2BE92;to=#78796B]><&l>⛏️ Magbungkal Crate ⛏️
    - <&8><&l>▶ <&r><&f>Season V: <&gradient[from=#92CFD2;to=#AB9D65]>(Crate name here)
