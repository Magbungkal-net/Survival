reapers_thornblade:
    ...
    display name: <&gradient[from=#93B1FF;to=#ADF3FD]>»-Reaper's Thornblade-«
    enchantments:
    - looting:4
    mechanisms:
        unbreakable: true
        ...
        attribute_modifiers:
            generic_attack_damage:
                1:
                    ...
                    amount: 9.5
                    slot: hand
                    id: 9f315ca0-0b20-4896-ba49-4efb63380d40
            generic_attack_speed:
                1:
                    operation: add_scalar
                    amount: 0.65
                    slot: hand
                    id: eecf186b-f4ec-43fc-ba8f-973eb496f450
    lore:
    - <empty>
    -   <&b>A deadly sword imbued with the essence of death itself. Its
    -   <&b>thorn-like edge tears through flesh and soul alike, leaving
    -   <&b>a mark that can never be erased.
    - <empty>
