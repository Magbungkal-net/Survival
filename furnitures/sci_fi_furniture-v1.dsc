...
scifi_furnitures_bed_money:
    ...
    - execute as_server "n give <player.name> sci_fi_furniture_v1_bed"
...
scifi_furnitures_bench_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_crystal_bench"
...
scifi_furnitures_bin_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_bin"
...
scifi_furnitures_cctv_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_dwarven_cctv"
...
#     script:
#     - execute as_server "money take <player.name> 750k"
#     - execute as_server "n give <player.name> sci_fi_furniture_v1_dwarven_door_mat"
...
scifi_furnitures_chair_1_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_chair_1"
...
scifi_furnitures_chair_2_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_chair_2"
...
scifi_furnitures_fence_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_fence"
...
scifi_furnitures_plant_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_plant"
...
scifi_furnitures_fence_corner_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_fence_corner"
...
scifi_furnitures_graffiti_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_graffiti"
...
scifi_furnitures_map_hologram_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_map_hologram"
...
scifi_furnitures_monitor_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_monitor"
...
scifi_furnitures_radio_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_radio"
...
scifi_furnitures_soda_storage_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_soda_storage"
...
scifi_furnitures_tv_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_tv"
...
scifi_furnitures_tablet_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_tablet"
...
scifi_furnitures_wall_lamp_1_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_wall_lamp_1"
...
scifi_furnitures_wall_lamp_2_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_wall_lamp_2"
...
scifi_furnitures_weapon_money:
    ...
    script:
    - execute as_server "money take <player.name> 750k"
    - execute as_server "n give <player.name> sci_fi_furniture_v1_weapon"
