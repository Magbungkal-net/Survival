...
flag_1_coins:
    ...
    - execute as_server "n give <player.name> japan_street_v4_flag_1"
...
flag_2_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_flag_2"
...
sign_1_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_1"
...
sign_2_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_2"
...
sign_3_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_3"
...
sign_4_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_4"
...
sign_5_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_5"
...
sign_6_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_6"
...
sign_7_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_7"
...
sign_8_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_8"
    - execute as_server "a <&f><&l><player.name> <&f>purchased Sign 8 from Japanese Street Furnituresusing coins (/warp furnitures)"
sign_9_coins:
    type: task
    debug: false
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_9"
...
sign_10_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_10"
...
sign_11_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_11"
...
sign_12_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_12"
...
sign_13_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_sign_13"
...
tree_pot_1_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_standing_tree_pot_1"
...
tree_pot_2_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_standing_tree_pot_2"
...
wood_chair_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 500"
    - execute as_server "n give <player.name> japan_street_v4_wood_chair"
