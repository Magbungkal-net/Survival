...
chinese_carpet_coins:
    ...
    - execute as_server "n give <player.name> chinese_furniture_v2_carpet"
...
chinese_china_gong_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_china_gong"
...
chinese_china_jade_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_china_jade"
...
chinese_coin_bowl_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_coin_bowl"
...
chinese_dragon_decoration_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_dragon_decoration"
...
chinese_earthquake_detector_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_earthquake_detector"
    - execute as_server "a <&f><&l><player.name> <&f>purchased Drum from Chinese Furnitures using coins (/warp furnitures)"
chinese_fan_coins:
    type: task
    debug: false
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_fan"
...
chinese_incense_burner_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_incense_burner"
...
chinese_jar_decoration_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_jar_decoration"
...
chinese_mask_decoration_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_mask_decoration"
...
chinese_paper_with_paintbrush_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_paper_with_paintbrush"
...
chinese_picture_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_picture"
...
chinese_pot_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_pot"
...
chinese_sofa_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_sofa"
...
chinese_standing_lamp_1_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_standing_lamp_1"
...
chinese_standing_lamp_2_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_standing_lamp_2"
...
chinese_tree_decoration_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_tree_decoration"
...
chinese_weapon_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_weapon"
...
chinese_wall_art_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> chinese_furniture_v2_wall_art"
