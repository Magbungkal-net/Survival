...
dwaeven_furniture_anvil_money:
    ...
    - execute as_server "n give <player.name> dwaeven_decoration_v1_anvil"
...
dwaeven_furniture_crystal_accent_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_crystal_accent"
...
dwaeven_furniture_drinking_horn_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_drinking_horn"
...
dwaeven_furniture_armor_stand_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_dwarven_armor_stand"
...
dwaeven_furniture_door_mat_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_dwarven_door_mat"
...
dwaeven_furniture_forge_fireplace_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_dwarven_forge_fireplace"
...
dwaeven_furniture_runes_wall_art_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_dwarven_runes_wall_art"
...
dwaeven_furniture_gemstone_mosaic_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_gemstone_mosaic"
...
dwaeven_furniture_goblet_collection_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_goblet_collection"
...
dwaeven_furniture_inscribed_stones_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_inscribed_stones"
...
dwaeven_furniture_map_of_the_under_mountain_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_map_of_the_under_mountain"
...
dwaeven_furniture_metallic_drapery_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_metallic_drapery"
...
dwaeven_furniture_mine_book_shelf_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_mine_book_shelf"
...
dwaeven_furniture_mine_cart_coffee_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_mine_cart_coffee"
...
dwaeven_furniture_mountain_murals_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_mountain_murals"
...
dwaeven_furniture_mountain_throne_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_mountian_throne"
...
dwaeven_furniture_smithy_themed_kitchen_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_smithy_themed_kitchen_money"
...
dwaeven_furniture_statue_of_dwaeven_hero_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_statue_of_dwarven_hero"
...
dwaeven_furniture_stone_work_lamp_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_stonework_lamp"
...
dwaeven_furniture_treasure_chest_money:
    ...
    script:
    - execute as_server "money take <player.name> 600k"
    - execute as_server "n give <player.name> dwaeven_decoration_v1_treasure_chest"
