...
wind_chime_coins:
    ...
    - execute as_server "n give <player.name> modern_japanese_furniture_wind_chime"
...
ceiling_light_1_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_ceiling_light_1"
...
ceiling_light_2_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_ceiling_light_2"
...
grill_table_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_grill_table"
...
dining_table_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_dining_table"
...
doorway_curtain_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_doorway_curtain"
...
floor_cushion_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_floor_cushion"
...
floor_light_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_floor_light"
...
futon_sofa_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_futon_sofa"
...
ikebana_Vase_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_ikebana_vase"
...
dkokatsu_table_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_dkokatsu_table"
...
paper_lamp_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_paper_lamp"
...
shoji_screen_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_shoji_screen"
...
table_bonsai_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_table_bonsai"
...
table_lamp_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_table_lamp"
...
tatami_bed_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_tatami_bed"
    - execute as_server "a <&f><&l><player.name> <&f>purchased Tatami Bed from Modern Japanese Furnitures using coins (/warp furnitures)"
furniture_table_coins:
    type: task
    debug: false
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_table"
...
tea_set_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_tea_set"
...
wall_light_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 800"
    - execute as_server "n give <player.name> modern_japanese_furniture_wall_light"
