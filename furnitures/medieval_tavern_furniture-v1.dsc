...
bar_coins:
    ...
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_bar"
...
bar_chair_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_bar_chair"
...
bar_corner_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_bar_corner"
...
bar_sign_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_bar_sign"
...
barrel_stack_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_barrel_stack"
...
beer_tank_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_beer_tank"
...
beer_tank_wall_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_beer_tank_wall"
...
candle_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_candle"
...
scarpet_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_carpet"
...
chair_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_chair"
...
dart_board_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_dart_board"
...
drinking_horn_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_drinking_horn"
...
glass_hanging_bar_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_glass_hanging_bar"
...
shelf_1_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_shelf_1"
...
shelf_2_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_shelf_2"
...
shelf_3_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_shelf_3"
...
shelf_4_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_shelf_4"
...
table_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_table"
...
wall_lamp_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_wall_lamp"
...
wanted_paper_coins:
    ...
    script:
    - execute as_server "magbungkalcoins take <player.name> 600"
    - execute as_server "n give <player.name> medieval_tavern_furniture_v1_wantd_paper"
