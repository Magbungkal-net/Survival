survival_deathlogs:
    ...
    events:
        ...
        - definemap embed_map:
            ...
            # title:
            color: orange
            description: "```yml<n>Category: Death<n>UUID: <[uuid]><n>Cause: <[cause]><n>Time: <[time]><n>XP Levels: <[exp]><n>Item drops: <[drops]><n>Location: <[player_location]><n>Player close: [<[player_close]>]<n>TPS: <[tps]><n>Money: <[money]>```"
