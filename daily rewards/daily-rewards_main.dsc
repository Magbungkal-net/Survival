DailyRewardsCommand:
    ...
    - if !<[player].has_flag[daily_reward]>:
       ...
       - playeffect effect:totem_of_undying at:<player.location.add[0,5,0]> quantity:20 data:1 offset:0.0
    ...
    - if <[player].has_flag[daily_reward]>:
        ...
        - playeffect effect:END_PORTAL_FRAME_FILL at:<player.location.add[0,3,0]> quantity:20 data:1 offset:0.0
