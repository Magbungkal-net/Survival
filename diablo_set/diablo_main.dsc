...
diablo_whole_set_event:
    ...
    - execute as_server "n give <player.name> diablo_chestplate"
    - execute as_server "n give <player.name> diablo_helmet"
    - execute as_server "n give <player.name> diablo_boots"
    - execute as_server "n give <player.name> diablo_leggings"
    - give diablo_axe
    - give diablo_bow
    - give diablo_crossbow
    - give diablo_hat
