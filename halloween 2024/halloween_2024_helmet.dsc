halloween_2024_helmet:
    type: item
    material: leather_helmet
    display name: <&gradient[from=#D2D2D2;to=#8D8D8D]>☠ Helm of Shadows ☠
    enchantments:
    - protection: 10
    mechanisms:
         unbreakable: true
    ...
    lore:
    - <empty>
    -   <&gradient[from=#D2D2D2;to=#D2D2D2]>An ornate helmet that shrouds the wearer in an aura of mystery.
    - <empty>
    - <&8><&l>【<&r><&gradient[from=#8D8D8D;to=#8D8D8D]>+35% Armor<&8><&l>】
    - <&8><&l>【<&r><&gradient[from=#8D8D8D;to=#8D8D8D]>+75% Armor<&8><&l>】
    - <&8><&l>【<&r><&gradient[from=#8D8D8D;to=#8D8D8D]>+18% Absorption<&8><&l>】
