halloween_2024_bow:
    ...
    - <empty>
    - <&8><&l>▶ <&r><&gradient[from=#D2D2D2;to=#D2D2D2]>When <&gradient[from=#8D8D8D;to=#8D8D8D]>left-clicks <&gradient[from=#D2D2D2;to=#D2D2D2]>apply <&gradient[from=#8D8D8D;to=#8D8D8D]>Moonlit Longbow Dash
...
halloween_2024_bowEvents:
    ...
    events:
      ...
      on player left clicks block with:halloween_2024_bow:
