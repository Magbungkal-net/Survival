...
serverinfo_cmd:
    ...
    events:
        ...
        - define verify_command !discordstats
        - if <[text].starts_with[<[verify_command]>]>:
          ...
          - definemap message_map:
                title: Magbungkal's Info
                description: "**📊 Discord Statistics**```yml<n>Owner: @eyjeey<n>Staffs: <[staffs]><n>Members: <[members]><n>Roles: <[roles]><n>Benefactors: <[benefactors]><n>Custom Rank: <[custom]><n>Titan: <[titan]><n>MVP++: <[mvp++]><n>MVP+: <[mvp+]><n>MVP: <[mvp]><n>VIP: <[vip]>```<n>**🏹 Gamemodes**<n><discord_user[1126905443617345598].mention><n><n>**📊 Survival Statistics**<n>```yml<n>Current Players: <[players]>/120<n>Performance: <[performance]>%<n>Uptime: <[uptime]> hours```"
                color: gray
