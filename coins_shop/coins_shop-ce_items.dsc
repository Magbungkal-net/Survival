  ...
  events:
    ...
    - if <context.item> == <item[fishtrak_ce]>:
      ...
      - if <[coins]> < <[price]>:
        ...
        - adjust <player> show_book:written_book[book_pages=<[text]>;book_title=nan;book_author=nan]
    # soultracker
    - if <context.item> == <item[soultracker_ce]>:
      - define price 1000
      - if <[coins]> >= <[price]>:
        - define event soultracker
        - clickable <[event]>_event save:<[event]>_event
...
soultracker_event:
    ...
    - execute as_server "ae giveitem <player.name> soultracker 1"
...
fishtrak_event:
    ...
    - execute as_server "ae giveitem <player.name> fishtrak 1 100"
