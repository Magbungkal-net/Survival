DiscordMarketplaceCommandInGame:
  ...
  - else:
      ...
      - definemap message_map:
          ...
          color: orange
          description: **Server:** **`SURVIVAL`**<n>**Item:** **`<[args].get[1].to_uppercase>`**<n>**Condition:** **`<[args].get[2].to_uppercase>`**<n>**Price:** **`₱<[args].get[3]>`**<n>**```<[args].get[4]>```**<n>**Date:** <[time]><n><n>Do direct message **<[player].to_uppercase>** if you have the said item, or interested selling/buying the said item.
          image: <[args].get[6]>
